...
summary: Con las alertas de BlueXP , puede ver las alertas asociadas con su entorno de almacenamiento de ONTAP y obtener detalles vinculados a System Manager de ONTAP. 
---
...
== Vea detalles sobre el clúster en ONTAP System Manager

. En la página de la lista Alertas, seleccione una alerta.
. En la alerta, haga clic en el nombre del clúster en la parte superior de la página.
+
System Manager de ONTAP ahora muestra información sobre el clúster.

+
image:alerts-system-manager-cluster.png["ONTAP System Manager muestra información del clúster"]
